        ...
        <>
            <div className="h-screen bg-black-600">
                <div className="flex justify-between">
                    ...
                    <div className="mr-60">
                        <button className="bg-white-100 rounded-lg w-[100px] h-10 mt-5 mr-5" onClick={RedirectToSignup}>Signup</button>
                        <button className="bg-blue-400 rounded-lg w-[110px] h-10">Admin Signup</button>
                    </div>
                </div>
                ...
                <div className="flex justify-center">
                    <div className="bg-black-100 rounded-lg w-[400px] h-[400px] mt-[80px]">
                        <div className="flex flex-col text-center mt-[30px]">
                            ...
                            <p className="text-lg font-medium tracking-tighter text-primary/75 md:text-xl text-white-300 mt-2">Log in to access paid content!</p>
                        </div>
                        <div className="mt-[40px] ml-[45px] text-white-100">
                            ...
                            <div className="ml-[1px] mt-[20px]">
                                <button className="bg-blue-400 w-80 rounded-lg h-10 pl-3" onClick={LoginCall}>Login</button>
                            </div>
                        </div>
                    </div>
                </div>
